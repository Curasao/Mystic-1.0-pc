...
define gui.about = _p("""
Спасибо сайту itch.io за предоставленные материалы:
Music: alkakrab
2d: Rosy (Au Crowne), Alice (Noraneko Games), Eidan (star-anise), Sam (runeraccoon), Amber (chibi785), backgrounds (lornn)
""")
...
define config.save_directory = "Mystic-1667244139"
