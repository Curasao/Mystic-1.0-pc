...
screen main_menu():
    ...
    imagemap:
     ground ("gui/overlay/fon.jpg")
     hotspot (30, 120, 150,80) action Start()
     hotspot (30, 270, 250,80) action ShowMenu("load")
     hotspot (30, 410, 380,80) action ShowMenu("preferences")
     hotspot (30, 535, 510,80) action Quit()
